...
public class ModArmorMaterials  {
    public static final RegistryEntry<ArmorMaterial> RUBY = ModArmorMaterials.register("ruby", util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
        ...
        map.put(ArmorItem.Type.BODY, 1);
            ...
            List.of(new ArmorMaterial.Layer(new Identifier(MetalFinders.MOD_ID, "ruby"), "", false))));
    ...
    private static RegistryEntry<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantability, RegistryEntry<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(new Identifier(MetalFinders.MOD_ID, id)));
    ...
    private static RegistryEntry<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantability, RegistryEntry<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient, List<ArmorMaterial.Layer> layers) {
        ...
        return Registry.registerReference(Registries.ARMOR_MATERIAL, new Identifier(MetalFinders.MOD_ID, id),
